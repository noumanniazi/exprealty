...
export const content2 = {
  heading: "This video will change your life.",
  paragraphs: [
    `It answers all your questions, shows you all the short-cuts, and gives you a quick and easy paint-by-the-numbers way to making staggering profits with EXP Realty.`,
    `Brief video below will show you the glimpse of what you can do while being a part of EXPRealty.`
  ]
};
export const content3 = {
  heading: "Revenue Share Model",
  paragraphs: [
    `Take a look at the video below to get in dept view of EXPRealty revenue sharing model.`,
  ]
};
